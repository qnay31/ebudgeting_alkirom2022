    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasi">Verifikasi</a></li>
    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="col-lg-12" id="form-pengajuan">
                <div class="row">
                    <?php include '../models/checklist/pengajuan_models/laporan-nav.php'; ?>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <?php } else { ?>
                        <?php include '../models/checklist/laporan_checklist/laporan_cekLogistik.php'; ?>
                        <?php } ?>
                    </div>
                </div><!-- End Laporan  -->
