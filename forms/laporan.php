...
if ($_GET["id_dataManagement"] == "program") {
    ...
    $q3  = mysqli_query($conn, "SELECT * FROM 2022_program WHERE id_pengurus = '$_SESSION[id_pengurus]' AND `posisi` = '$_SESSION[posisi]' AND laporan = 'Belum Laporan' AND id = '$id' AND MONTH(tgl_pengajuan) = '$unik' ORDER BY `tgl_pengajuan` DESC");
    ...
    $q3  = mysqli_query($conn, "SELECT * FROM 2022_logistik WHERE id_pengurus = '$_SESSION[id_pengurus]' AND `posisi` = '$_SESSION[posisi]' AND laporan = 'Belum Laporan' AND id = '$id' AND MONTH(tgl_pengajuan) = '$unik' ORDER BY `tgl_pengajuan` DESC");
    $data       = mysqli_fetch_assoc($q3);
    $id_unik    = $data["id"];
    ...
    $q3  = mysqli_query($conn, "SELECT * FROM 2022_paudqu WHERE id_pengurus = '$_SESSION[id_pengurus]' AND `posisi` = '$_SESSION[posisi]' AND laporan = 'Belum Laporan' AND id = '$id' AND MONTH(tgl_pengajuan) = '$unik' ORDER BY `tgl_pengajuan` DESC");
    $data       = mysqli_fetch_assoc($q3);
    $id_unik    = $data["id"];
    ...
    $q3  = mysqli_query($conn, "SELECT * FROM 2022_$id_management WHERE id_pengurus = '$_SESSION[id_pengurus]' AND `posisi` = '$_SESSION[posisi]' AND laporan = 'Belum Laporan' AND id = '$id' AND MONTH(tgl_dibuat) = '$unik' ORDER BY `tgl_dibuat` DESC");
    $data       = mysqli_fetch_assoc($q3);
    $id_unik    = $data["id"];
            ...
            <div class="col-lg-12" id="form-pengajuan">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <?php include '../models/forms/laporan_form/laporan_program.php'; ?>

                        <?php } elseif ($_GET["id_dataManagement"] == "logistik") { ?>
                        <?php include '../models/forms/laporan_form/laporan_logistik.php'; ?>

                        <?php } else { ?>
                        <?php include '../models/forms/laporan_form/laporan_management.php'; ?>
                        <?php } ?>
                    </div>
                </div><!-- End Laporan  -->
