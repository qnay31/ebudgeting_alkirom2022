...
$q = mysqli_query($conn, "SELECT * FROM 2022_data_paudqu");
$i = 1;
$sql = $q;
...
<div class="row">
    ...
    <div class="col-xxl-12 col-md-12">
        <div class="card customers-card">
            <h5 class="card-title text-center">Detail Global PaudQu El-ZamZam</h5>
        </div>
    </div><!-- End Card -->
    ...
    <div class="col-xxl-12 col-md-12">
        <div class="card info-card customers-card">
            <div class="card-body">
                <h5 class="card-title">PaudQu El-ZamZam</h5>
