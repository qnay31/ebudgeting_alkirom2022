<nav class="stroke">
    <ul>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuan">Pengajuan
                <?php if ($s > 0) { ?>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporan">Laporan
                <?php if ($s3 > 0) { ?>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanPaudqu">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporanPaudqu">Laporan
                <?php if ($s3 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s3 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanAset">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporanAset">Laporan
                <?php if ($s3 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s3 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanUangmakan">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporanUangmakan">Laporan
                <?php if ($s3 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s3 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanGajikaryawan">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporanGajikaryawan">Laporan
                <?php if ($s3 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s3 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanAnggaranlain">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporanAnggaranlain">Laporan
                <?php if ($s3 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s3 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanMaintenance">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporanMaintenance">Laporan
                <?php if ($s3 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s3 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pemasukanMedia">Pemasukan
                <?php if ($s+$s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s+$s2 ?></span>
                <?php } ?>
            </a>
        </li>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanOperasional">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporanOperasional">Laporan
                <?php if ($s3 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s3 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanJasa">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporanJasa">Laporan
                <?php if ($s3 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s3 ?></span>
                <?php } ?>
            </a>
        ...
        <?php } else { ?>
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanLogistik">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_laporanLogistik">Laporan
                <?php if ($s3 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s3 ?></span>
                <?php } ?>
            </a>
