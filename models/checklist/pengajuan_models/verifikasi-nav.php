<nav class="stroke">
    <ul>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasi">Verifikasi
                <?php if ($s2 > 0) { ?>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiPaudqu">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiAset">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiUangmakan">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiGajikaryawan">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiAnggaranlain">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiMaintenance">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiOperasional">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiJasa">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active"
                href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiLogistik">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
